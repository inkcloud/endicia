...
class Endicia {
    constructor(options) {
        ...
        this.request = request_promise_1.default.defaults({
            baseUrl
        });
    ...
    rateSingle(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                const r = xml2js_1.parseString(response, { explicitArray: false }, (err, data) => {
    ...
    getPostageLabel(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const xml = this.getBase('LabelRequest', false)
                ...
                .ele('PartnerTransactionID', data.orderRefernence || shortid_1.default.generate()).up()
